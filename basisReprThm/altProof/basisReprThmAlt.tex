...
We also note that the Lemma holds for the case when \(n=0\) as \((c_0) = c_0b^0\)
\end{jprIn}
Induction step: Assume the lemma is true for \(n=k\) and prove that it must be true for \(n=k+1\).
QED
