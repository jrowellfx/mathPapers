...
that our theorem could be false, is if the axioms themselves were false.
...
You are about to jump into the deep end read something that's probably unlike most
things you come across in your day-to-day activities.
...
and is always followed by something that is a ``set", one of which we've talked about above,
namely the symbol $\mathbb{Z}_{\ge 0}$ which
...
going, a detailed explanation follows to guide you through the unfamiliar territory.
...
We should probably prove our two theorems above.
...
After all that - I invite you to skip all the way to the Epilogue and Exercises section of this
paper. Truth be told, the proof is kind of tedious, and heavy going following subscripts and such.
Take a breather, try the exercises, and then perhaps come back to the proof later.
