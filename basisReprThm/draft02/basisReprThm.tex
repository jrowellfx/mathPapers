...
--jpr rewrite-- Think of each digit as being a little dial that controls how many lots
...
--jpr rewrite-- Let's look at another example - we don't have a word for this next number,
...
\bigskip
--jpr rewrite, I vs you vs we --  Something else we know intuitively is that each number written
...
--jpr rewrite - use smiley face for 10? -- The other choice is we could cheat a little,
...
approach (i.e.; induction) might not lead to the ``uniqueness" aspect of 
the theorem imagine
a magic box
...
representations of each integer - that is;
