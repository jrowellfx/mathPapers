...
I just made up the notation $d_{\{0,1,2,3,4\}}$ which I'm hoping coveys the information that any of those five `$d$'s lies between 0 and 9 inclusive. A more 
...
our hard-coded five-digit expression to an arbitrarily large
number of digits (or any size for that matter, even one digit).
...
\end{tabular}
\end{center}
Using $k$ like this let's us specify ANY amount of digits we want.  If we let $k=0$ we get the first ``single digit'' 
