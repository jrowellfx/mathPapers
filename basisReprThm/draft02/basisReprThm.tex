...
Identities: There are integers 0 and 1 such that, $a+0=a$ and $a\times1=a$ and
...
in ANY other way if we follow this kind of procedure.  In other words, each integer is representable by only ONE base-ten number.
