...
it's negative counterpart''.  Also zero is easy to deal separately, so to keep our lives
...
\emph{Base-Ten Representation Theorem (wordy)}
\begin{jprIn}
...
each digit has to be less than the value of ten, but any number less than ten (including zero).  So now the Base-Ten Representation Theorem
might look like this:

\emph{Base-Ten Representation Theorem}: Let $n$ be a positive integer, then $n$ can be uniquely written in base-ten
...
we sounded it out for the Base-Ten Representation Theorem - it's
