...
Such a careful statement is called a theorem - theorems require proof which we will get to. It might get tough once we get
to the proof. You are
probably going to have to
exercise some math-brain-muscles which is hard work, but like any workouts, the more you
do them, and make even a tiny effort, the stronger you get, so I encourage you to persevere.
...
After that has been established we will use another technique
...
\begin{jprIn}
For all $a,b\in{}\mathbb{Z}$ where $b\ne0$, there exists unique integers $q$ and $r$ such that:
