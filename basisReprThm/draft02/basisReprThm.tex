...
And since the digit $1<b$ then we've proven the base case, in other words
...
In base-ten $d_0$ can be at most eight, etc.\footnote{Please read the bidirectional arrow symbol $\Leftrightarrow$ as ``if and only if'' - it's like a logical ``equals'' sign}
%\footnote{Use
