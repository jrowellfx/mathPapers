...
impunity knowing that we can ``name'' each and every integer with it's own unique label.
...
Moving forward it would be helpful to have a name, or label, to stand in for our 
...
Answer: They wouldn't know - so that's why it's important to spell it out.
