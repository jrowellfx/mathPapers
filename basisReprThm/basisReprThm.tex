...
Mathematics deals with numbers in a pure sort of way, divorced from the symbols
...
represents a quantity of successively larger piles of apples. In fact sometimes (when thinking about mathy-stuff)
...
Since our ability to count in decimal is not axiomatic, then to properly ground
...
as ``a thousand'' or ``one lot of a thousand, plus zero ...etc''.
