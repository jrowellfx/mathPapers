...
If we could hit the reset-button on how we count
using decimal numbers, and were tasked with finding the \emph{best} number system for use,
...
Then what criteria might we use to select which number system we'd adopt for counting?
