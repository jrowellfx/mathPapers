...
define what it means to write out a number in base-ten,
...
describe how we learned to count watching Sesame Street? If you let $b=\text{ten}$
in the above theorem, then we have the ``Base-Ten Representation Theorem''. We could let $b=2$, then we'd have
``Base-Two Representation Theorem'' which states how we count in binary.

This theorem is a good example of what mathematicians like to do - they generalize ideas.
...
use base-fourty-nine.  By generalizing the idea to a base $b$, where $b$ is any number two or higher,
