...
We got it drilled into us watching Sesame Street that it's this many apples
``\faApple{}\faApple{}\faApple{}\faApple{}\faApple{} \faApple{}\faApple{}\faApple{}\faApple{}\faApple{}'',
or is the number of fingers on a typical person's two hands.

That Sesame Street training was great. We need to be able to count with ease and to
automatically associate the symbol ``10'', that is; a one-followed-by-a-zero,
with the number that represents ten things.

Once we are trained to think of ``10'' as ten, we quickly move past it to learn about 100 and 1000
...
Furthermore, learning how to add and multiply is pretty simple once you can count in
base-ten since the techniques are simple and straight-forward.

What about kids in ancient Rome?
...
Even though we use different symbols, ancient Romans and us
are talking about the same set of numbers. The idea of the number undeneath
is exactly the same once you peel the symbol away.
Mathematics deals with numbers in this pure sort of way, divorced from the symbols used for counting.

When a mathematical theorem talks about whole numbers, it's really talking about the set of numbers 
that represent successivly larger piles of apples.
...
us to specify an integer that has a billion-and-one
