...
Let's examine some magic-numbers (according to our proposed
usage of the term) in other bases.
...
%We also might use the following symbol to say that ``$b$ does not divide $a$'',
%\[b\nmid{}a\]
%
