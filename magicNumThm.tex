...
%by another number.  Recall the ``Euclidean Division Theorem'' which says the following:
%
...
\[a=b\cdot{}c\]
We express the fact that $b$ is a divisor of $a$, or that 
``$b$ divides $a$'' with this notation:
\[b\big|a\]
So the following is always true:
%\[1\big|a\text{, and }a\big|a\]
\[1\big|a,\text{\hspace{1em}and\hspace{1em}}a\big|a\]

\[a\mid{}b, a\big|b, a\hspace{-4pt}\not\bigm|b, {a}\not\big|\hspace{2pt} b\]

\[a \not\hspace{2pt} \bigm| b \]
...
After all both ``Schoolhouse Rock'' AND ``The School of Rock'' sanction the usage -
so we may be on to something big here.
