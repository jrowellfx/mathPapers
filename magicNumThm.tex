...
That is; for $b>1$ there are a sequence of integers $d_0, d_1, d_2,\dots{},d_k$ (where $0\le{}d_i<b$\\
for all $i$ in $\{0,1,2,\dots{},k\}$ and $d_k\ne0$) such that,

\hspace{3em}$n=d_kb^k+\dots+d_2b^2+d_1b^1+d_0b^0$, which is the base-$b$-representation of $n$.
