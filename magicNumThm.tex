...
$b-1$ (like 4 in the first example) acts like a magic-number in base-$b$
(base-5 in the first example, because clearly 4 divides 268 sixty-seven times,
but writing out 268 in base-5, then the sum of those digits is also divisible by 4).
%$b-1$ (like 15 in the third example) acts like a magic-number in base-$b$ (because clearly 15 divides 345,
%but writing out 345 in base-16, then the sum of adding up those digits is also divisible by 15).
