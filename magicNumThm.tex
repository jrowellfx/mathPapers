...
divisibility property when adding up its digits a ``magic-number''?
...
notation, but instead of base-10 they probably use base-7, base-21,
maybe even base-49. An understanding of magic-numbers in one-of-those-bases
might come in handy when trying to learn their times-tables!
...
by another number\footnote{See
``\href {https://www.dropbox.com/s/bwmrffmkcidnf27/basisReprThm.pdf?dl=0} {Counting}'' p. 21,
also written by J.P. Rowell}.
...
``\href{https://www.dropbox.com/s/bwmrffmkcidnf27/basisReprThm.pdf?dl=0} {Counting} p. 2''}:
