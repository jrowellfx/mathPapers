...
% \end{itemize}
\begin{alignat*}{6}
 2&\cdot{}409\cdot{}1129=923522  &&\text{ is } (10001)_{31} &&\quad\text{and}\quad & 1+0+0+0+1&=2 \\
 3&\cdot{}641=1923               &&\text{ is } (201)_{31}   &&\quad\text{and}\quad & 2+0+1&=3 \\
 5&\cdot{}139\cdot{}2659=1848005 &&\text{ is } (20102)_{31} &&\quad\text{and}\quad & 2+0+1+0+2&=5 \\
 6&\cdot{}10091=60546            &&\text{ is } (2103)_{31}  &&\quad\text{and}\quad & 2+1+0+3&=6 \\
10&\cdot{}197\cdot{}941=1853770  &&\text{ is } (20701)_{31} &&\quad\text{and}\quad & 2+0+7+0+1&=10 \\
15&\cdot{}71503=1072545          &&\text{ is } (15027)_{31} &&\quad\text{and}\quad & 1+5+0+2+7&=15
\end{alignat*}
...
however, since we've only looked at some examples, we can't make that claim unless we prove it for ALL
such situations.
...
QED
\section*{Epilogue}
Blah blah blah - look for ``Heptapods have the best number system''!
\end{document}
