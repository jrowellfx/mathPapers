...
% (eg. \(\frac{a_k}{k!}\))
is non-zero.
The definition adds back \(\{0\}\) for consistency, since otherwise it would be excluded.
...
is in all but finitely many \(\mathcal{F}_i\).
...
\begin{center}
\begin{alignat}{1}
\lim_{n \to \infty}\mathcal{F}_n &= \mathcal{F} \label{eqn02}\\
\mathcal{F} &= \mathbb{Q}_{p<q} \label{eqn03}\\
\lim_{n \to \infty}\mathcal{S}_n &= \mathcal{S} \label{eqn04}\\
\mathcal{S} &= \mathcal{F} \label{eqn05}\\
\mathcal{S} &= \mathbb{Q}_{p<q} \label{eqn06}
% 
% \mathbb{Q}_{p<q}
% = \mathcal{F}
% = \lim_{n \to \infty}\mathcal{F}_n
...
% , i.e.; \(\frac{p}{k!} \in \displaystyle{\lim_{n \to \infty}\mathcal{F}_n}\).
...
% \in \displaystyle{\lim_{n \to \infty}\mathcal{F}_n}\)
hence, \(\displaystyle{\mathcal{F} = \lim_{n \to \infty}\mathcal{F}_n}\). \quad QED equation \eqref{eqn02}.

Proof of equation \eqref{eqn03}: If \(\frac{p}{k} \in \mathbb{Q}_{p<q}\)
...
for all \(\frac{p}{k} \in \mathbb{Q}_{p<q}\), i.e.; \(\mathcal{F} = \mathbb{Q}_{p<q}\). \quad QED \eqref{eqn03}.
...
We note that there must be at least one non-zero term in equation \eqref{eqn07} otherwise
...
\dots{} = 
a_{n-1} =
a_{n} = 0\). Therefore we can rewrite equation \eqref{eqn07},
