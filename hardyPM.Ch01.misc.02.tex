...
\section*{Theorem}
Any positive rational number can be expressed in one and only one way in the form\par
\begin{center}
\(a_1 + \frac{a_2}{1\cdot{}2}
+ \frac{a_3}{1\cdot{}2\cdot{}3}
+ \dots{}
+ \frac{a_k}{1\cdot{}2\cdot{}3\cdot{}\dots{}\cdot{}k},\)\par
\end{center}
where $a_1, a_2, \dots{}, a_k$ are integers, and\par
\begin{center}
