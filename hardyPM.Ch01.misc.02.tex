...
The set \(\mathcal{F}_\infty\) is the limit of the sequence
\(\mathcal{F}_2, \mathcal{F}_3, \mathcal{F}_4, \dots{}\), if and only if for all \(a;\newline
a \in \mathcal{F}_\infty\ \Leftrightarrow\ 
...
= \{\frac{a_2}{2!} + \frac{a_3}{3!} + \dots{} + \frac{a_k}{k!} \mid
% \forall\ 
k\!\ge{}\!2,\ 
0\!\le{}\!a_2\!<\!2,\ 
0\!\le{}\!a_3\!<\!3,\ 
...
% \(a \in \mathcal{F}_\infty \Leftrightarrow 
% \text{ there exists } N, \text{ where for all }
% n \ge N, a \in \mathcal{F}_n\)
% 
% (Similarly for \(\mathcal{S}_\infty\).)
\section*{Lemma 4}
...
\begin{center}
\begin{equation*}
\mathcal{F}_\infty =\; \mathbb{Q}_{p<q} = \mathcal{S}_\infty
\end{equation*}
\end{center}
\egroup
}
...
We first note that the limit-set \(\mathcal{F}_\infty\) exists by the following reasoning;

For all integers \(k \ge{} 2\), we know
...
thus satisfying the criterea for the existence of the limit-set.
