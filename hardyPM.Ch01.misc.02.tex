...
Here's what it means for a set to be the limit of a sequence of sets (for example):
...
\begin{center}
\begin{alignat}{1}
\lim_{n \to \infty}\mathcal{F}_n &= \mathcal{F} \label{eqn3}\\
\mathcal{F} &= \mathbb{Q}_{p<q} \label{eqn4}\\
\lim_{n \to \infty}\mathcal{S}_n &= \mathcal{S} \label{eqn5}\\
\mathcal{S} &= \mathcal{F} \label{eqn6}\\
\mathcal{S} &= \mathbb{Q}_{p<q} \label{eqn7}
% 
% \mathbb{Q}_{p<q}
% = \mathcal{F}
% = \lim_{n \to \infty}\mathcal{F}_n
...
\(\frac{p}{k!} \in \mathcal{F}_N\), then \(\frac{p}{k!} \in \mathcal{F}_n, \forall\ n \ge{} N\), i.e.;
\(\frac{p}{k!} \in \displaystyle{\lim_{n \to \infty}\mathcal{F}_n}\).
