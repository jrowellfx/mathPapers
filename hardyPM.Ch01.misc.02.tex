...
Therefore, \(\frac{p}{q} \in{} \mathcal{S}_n\) for all \(n > k\).
...
we are done, however if there is a fractional remainder \(\frac{p}{q}\) (such that
\(p\) and \(q\) are co-prime) then \(\frac{p}{q}\) is a member of all sets \(\mathcal{S}_n\)
such that \(n \ge{} q\).
