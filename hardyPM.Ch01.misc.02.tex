...
Therefore, \(\frac{p}{q} \in{} \mathcal{S}_n\) for all \(n > k\), also demonstrating
that the sum for \(\frac{p}{q}\) is the same for all \(n > k\), establishing it's unique
association with \(\frac{p}{q}\). QED
