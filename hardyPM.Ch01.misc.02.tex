...
Here it is, followed by my proof which starts out with
some lemmas to get us rolling\footnote{Please note that
the variables used in this
paper (e.g. \(a, b, a_1, a_2, a_k, i, k, p, q,\) etc.) are all integers.}.
