...
% (eg. \(\frac{a_k}{k!}\))
is non-zero.
The definition adds back \(\{0\}\), for consistency, since the definition in the set description excludes it.

Finally,
\(\mathbb{Q}_{p<q}\) is just the set of ALL non-negative rational numbers less than one.

Here's what it means for a set to be the limit of a sequence of sets:
...
is in all but finitely many \(\mathcal{F}_n\).
...
We'll first show that the set {\footnotesize\(\displaystyle{\mathcal{F} = \lim_{n \to \infty}\mathcal{F}_n}\)}.

Observe that for all integers \(k \ge{} 2\), we know
that \(\frac{p}{k!} \in \mathcal{F}_k\)
and since \(\frac{(k+1)\cdot{}p}{(k+1)\cdot{}k!} = \frac{(k+1)\cdot{}p}{(k+1)!}\),
therefore \(\frac{(k+1)\cdot{}p}{(k+1)!} \in \mathcal{F}_{k+1},
\text{ hence } \mathcal{F}_k \subset \mathcal{F}_{k+1}\).
...
\subset \mathcal{F}_4
\subset \dots{}
\), for all \(\mathcal{F}_i\), \(i \ge{} 2\). Therefore once an element is introduced to
a set \(\mathcal{F}_i\), then it is in all subsequent sets in the sequence.

Now just describe that for some element of F, which k it belongs to and so N is that k in limit definition...

Therefor for all \(a; 
a \in \mathcal{F}\ \Leftrightarrow\ 
\exists N, \text{ such that }
\forall n \ge N, a \in \mathcal{F}_n.\) and hence \(\mathcal{F}\) is the
limit of the sequence of sets \(\mathcal{F}_2, \mathcal{F}_3, \mathcal{F}_4, \dots{}\).

Similarly we can show
that the set {\footnotesize\(\displaystyle{\mathcal{S} = \lim_{n \to \infty}\mathcal{S}_n}\)}.
...
\dots{},\ 
0\!\le{}\!a_k\!<\!k\).
Therefore, \(\frac{a_2}{2!} + \frac{a_3}{3!} + \dots{} + \frac{a_k}{k!} + \frac{0}{k!}  \in \mathcal{S}_{k+1}\) for
...
\subset \mathcal{S}_4
\subset \dots{}
\), for all \(\mathcal{S}_i\), \(i \ge{} 2\). Therefore once an element is introduced to
a set \(\mathcal{S}_i\), then it is in all subsequent sets in the sequence.

Therefor for all \(a; 
a \in \mathcal{S}\ \Leftrightarrow\ 
\exists N, \text{ such that }
\forall n \ge N, a \in \mathcal{S}_n.\) and hence \(\mathcal{S}\) is the
limit of the sequence of sets \(\mathcal{S}_2, \mathcal{S}_3, \mathcal{S}_4, \dots{}\).
...
Therefore \(\frac{p}{k}\) is an element of \(\mathcal{F}_k\), hence an element of \(\mathcal{F}\)
...
\(\frac{p}{q} \in \mathcal{F}\), and Lemma 3 tells us that
\(\mathcal{S}_k = \mathcal{F}_k\) for all \(k \ge 2\), therefore \(\frac{p}{q} \in \mathcal{S}\).
