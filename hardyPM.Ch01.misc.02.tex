...
\begin{center}
\begin{equation*}
\mathcal{S} = \{\frac{a_2}{2!} + \frac{a_3}{3!} + \dots{} + \frac{a_k}{k!}\enspace\mid\enspace 
0\! \le{}\! a_2\! <\! 2,\enspace 
0\! \le{}\! a_3\! <\! 3,\enspace 
...
\begin{center}
\begin{equation*}
\mathcal{F} = \{\frac{0}{k!},\enspace \frac{1}{k!},\enspace \frac{2}{k!},\enspace \dots{},\enspace \frac{k!-1}{k!}\}
\end{equation*}
\end{center}
\egroup
}
...
It's clear that the set \(\mathcal{F}\) contains every rational number with denominator \(k!\)
such that \(0\le{}\frac{p}{k!}<1\) and the size of \(\mathcal{F}\) is \(k!\, \). To show
that the set \(\mathcal{S}\) is the same
as \(\mathcal{F}\), it suffices to show that every member of \(\mathcal{S}\)
is also of the form \(0\le{}\frac{p}{k!}<1\), and that the size of the set is also \(k!\, \).

The smallest member of the set \(\mathcal{S}\) 
is \(\frac{0}{k!}\) and
...
We also note that every member of \(\mathcal{S}\) can be written as a rational number
...
Therefor any member of the set \(\mathcal{S}\) is of the form \(0\le{}\frac{p}{k!}<1\),
...
\end{center}
\egroup
Therefor \(\frac{p}{q}\) is an element of \(\mathcal{F}\) which is the same as the set \(\mathcal{S}\).\par
QED
}
