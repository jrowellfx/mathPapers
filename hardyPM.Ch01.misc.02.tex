...
% What follow are some thoughts
% that pointed me in a certain direction,
% which led to the proof below.
...
Also, it became clear that including zero (that is, not JUST positive rational numbers) was
going to make things easier with this more restrictive approach of forgetting all the
rational numbers greater than or equal to one.
...
Also, assigning zeros to all the variables then naturally we get \(\frac{0}{k!}\)
which is the smallest non-negative value possible.

Furthermore it's pretty obvious how to make the smallest such positive rational number: \(\frac{1}{k!}\) by
letting all the terms be zero except for \(a_k = 1\).
...
I then realized how easy it was count how many of these things there were. etc....

We have two choices for a2, and three choices for a3 etc.
...
Hmmm, the following set also has \(k!\) members,
