...
\end{center}
% Note: \(\frac{p}{k!} \in \mathcal{F}_k \Rightarrow \frac{p}{k!} \in \mathcal{F}\).
% 
% QED \eqref{eqn02}.
...
% (\(k, a_2, a_3, \dots{}, a_k \in \mathbb{Z}\) where
% \(k \ge{} 2, 0\!\le{}\!a_2\!<\!2,\ 
% 0\!\le{}\!a_3\!<\!3,\ 
% \dots{},\ \newline 0\!\le{}\!a_k\!<\!k\)),
since
...
Let \(a \in \mathcal{S}\), such that its smallest non-zero term in the sum
...
hence, \(\displaystyle{\mathcal{S} = \lim_{n \to \infty}\mathcal{S}_n}\).
% 
% QED \eqref{eqn04}.

\bigskip
Because of equality between Sk and Fk then each of S and F are limits of other Fk and Sk ie S = F, hence S = Q.
...
The following can be greatly similified.  JPR
