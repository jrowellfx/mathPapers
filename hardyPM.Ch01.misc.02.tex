...
where \(0 \le{} \frac{p}{q} < 1\), then it should be simple to extend it to ALL rational numbers
...
Induction: When \(k = 2\) it's true that \(\frac{1}{2!} = \frac{2!-1}{2!}\), and noting that
...
If \(a \in \mathcal{S}_k\), then the sum \(a = \frac{a_2}{2!} + \frac{a_3}{3!} + \dots{} + \frac{a_k}{k!}\),
where
\(k \ge{} 2\), and \(0\! \le{}\! a_2\! <\! 2,\enspace
0\! \le{}\! a_3\! <\! 3,\enspace
\dots{},\enspace\newline 0\! \le{}\! a_k\! <\! k\), is called the ``factorial-representation'' of \(a\).
...
the sets
\(\mathcal{F}_k\) and
\(\mathcal{S}_k\) are equal, which you may recall means \(a \in \mathcal{F}_k \Leftrightarrow a \in \mathcal{S}_k\).
...
to get unique members of the set (otherwise the set isn't well defined).
...
This infinite chain of super-sets helps us to think about the
...
\(2\!+\!\frac{1}{2!}\!+\!\frac{1}{3!}\!+\!\frac{1}{4!}\!+\!\frac{1}{5!}\!+\!\dots{}\) is not in \(\mathcal{S}\)
...
this number isn't rational - it's \(e\).
