...
\newcommand{\jprVersion}{v35} % version
...
\hypersetup{
    pdfauthor={James Philip Rowell},
    pdfcopyright={Copyright 2017-2020 by James Philip Rowell. All rights reserved.}
}
\usepackage{lipsum}
...
to a different base.
In each example, please note the 
first number being multiplied versus the base of the converted-number. In our first example
%the base is 5 and
we look at the integer 268, which is $5-1$ (otherwise known as 4) times 67 but we examine it written in
base-5. See how when we sum up the digits of the converted number, the sum is divisible by 4.
%{\small
%\begin{itemize}
