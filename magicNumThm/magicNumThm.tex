...
\newcommand{\jprVersion}{v36.2} % version
...
\hypersetup{
    pdfauthor={James Philip Rowell},
    pdfcopyright={Copyright 2017-2025 by James Philip Rowell. All rights reserved.},
    pdfpagemode=UseNone
}
\usepackage{lipsum}
\usepackage{wasysym}
...
In the film ``\href{https://en.wikipedia.org/wiki/School_of_Rock}{School of Rock}'',
Jack Black's character Mr. S.
has to demonstrate one of his ``teaching methods'' for the school 
principal Miss Mullins.
So he improvises ``\href{https://youtu.be/4KJD4aP90YQ?si=z8Y7J8BW8J52MObI}{The
Math Song}'', the final line being
``\dots{}\twonotes{} yes it's nine \twonotes{}\dots{} and that's
a magic-number \twonotes{}\dots{}''

I believe Jack was tipping his hat
to the ``Schoolhouse Rock'' song
``\href{https://youtu.be/bEcjFRB-1C4?si=HxKt_tgZ4XlZyVwf}{3 Is A Magic Number}''
...
of a number, also involving the number 9.
...
the paper ``\href {https://github.com/jrowellfx/mathPapers/blob/master/basisReprThm/basisReprThm.pdf}
{Counting}''}, so they might have different magic-numbers from us.
...
In the first example 4 divides 268 (sixty-seven times),
but when writing out 268 in base-5 we can see that the
sum of those digits is also divisible by 4.

Similarly in the second example 7 divides 1267, and 1267 written in base-8 
shows us that the sum of those digits is also divisible by 7. Similar story with the
remaining examples.
...
by another
number\footnote{``\href {https://github.com/jrowellfx/mathPapers/blob/master/basisReprThm/basisReprThm.pdf}
{Counting}'' p. 21}.
...
base\footnote{``\href{https://github.com/jrowellfx/mathPapers/blob/master/basisReprThm/basisReprThm.pdf}
{Counting} p. 2''}:
