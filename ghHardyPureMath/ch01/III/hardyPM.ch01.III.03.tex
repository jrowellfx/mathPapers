...
\maketitle
\begin{em}
\centerline{\small{}From `A Course in Pure Mathematics' by G. H. Hardy. Chapter 1, Section 5, Examples III.}
%\par
...
In `Example 2'\footnote{Hardy doesn't call them `Exercises' or `Questions', but that's what they
are, i.e.; the problems for the student to sink their teeth into.} from
Hardy's `Pure Mathematics', chapter 1, section 5, examples III, he has
us examine a sequence of rational approximations to $\sqrt{2}$, that is:\newline
...
\bigskip
In the next `Example 3' we are asked to prove a theorem, which I do
directly following its statement below, starting with the lemma.
